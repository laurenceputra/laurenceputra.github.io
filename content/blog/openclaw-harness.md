...
### `methodologies/abstracted-writing-system.md`

````markdown
# Abstracted Writing System: The CRCM Framework

A universal pattern for persuasive writing that moves from acknowledgment to normative stance. Applicable to LinkedIn posts, blog articles, opinion pieces, emails, and reports.

*For a LinkedIn-specific implementation with production workflows and audience considerations, see `methodologies/linkedin-writing-system.md`.*
...
### Phase 1: Concede
**Job:** Meet readers where they are. Acknowledge what they already believe before challenging it.

**What this looks like:**
- Open with a shared observation, common belief, or genuine truth
- Validate the emotional or logical weight of that belief
- Do NOT strawman. Make the concession strong enough that the reversal earns its weight.

**Key principle:** Earn trust before disruption.

### Phase 2: Reclassify
**Job:** Name the hidden variable. Shift the frame to what's actually happening.

**What this looks like:**
- Introduce a distinction, redefinition, or reframing
- Use precise language to separate what people conflate
- Anchor in a mechanism or principle, not just "the real truth is..."

**Key principle:** Replace the obvious frame with the real one.

### Phase 3: Compress
**Job:** Land the implications. Make the insight quotable and concrete.

**What this looks like:**
- 1-3 sentences translating the reclassification into consequences
- The "so what" that makes the reader's mental model shift
- Shortest phase, highest-density

**Key principle:** Sharpen, don't summarize.

### Phase 4: Moralize
**Job:** Close with a normative stance. Leave readers with a clear claim about what should be done or believed.

**What this looks like:**
- Opinionated, directional, compact statement
- Not a summary. A demand, choice, or principle.
- Must feel earned by the preceding logic.

**Key principle:** End with what we owe each other or what to do differently.

## 2. Pre-Draft Questions (Universal)

Answer these before writing:

1. **One-sentence repeat:** What single sentence do you want readers to repeat to someone else?
2. **Common belief:** What do most people in your audience already believe about this?
3. **Hidden variable:** What's the real mechanism that the common view misses?
4. **Source:** Where did this insight come from? (Experience, data, conversation, pattern, research)
5. **Moral:** What should readers do or believe differently?

If you can't answer all five, you're not ready to draft.

## 3. Anti-Predictability Toolkit

The CRCM pattern is fixed; execution should vary. Rotate these dimensions:

### Variation Dimensions
1. **Opening shape:** Observation, misstep, question, contradiction, data point, quote
2. **Hidden variable label:** 1-3 word noun phrase for the real mechanism
3. **Personal voice slot:** Proof, stakes, changed belief, credence (use 1-2 slots max per piece)
4. **Cadence pattern:** Dense→hammer placement variations
5. **Evidence type:** Direct encounter, case study, analogy, counterexample

**Rule:** Change at least 2 dimensions per piece to avoid formulaic writing.

## 4. Revision Checklist

### Structure
- [ ] All four phases present (Concede, Reclassify, Compress, Moralize)?
- [ ] Concede genuine (not strawman)?
- [ ] Reclassify names one hidden variable?
- [ ] Compress is sharpening, not summary?
- [ ] Moralize follows necessarily from argument?

### Variation (vs. last 3 pieces)
- [ ] Opening shape different?
- [ ] Hammer placement not identical?
- [ ] Personal voice in different slot?
- [ ] Evidence type different?

### Craft
- [ ] No em dashes (hard rule)
- [ ] Short paragraphs, one idea each
- [ ] Concrete nouns, action verbs
- [ ] Final sentence shorter than preceding paragraph
- [ ] First person used only in designated slots (max 2)

## 5. Content Engine: Workflow

### Production Stages
```
RAW IDEA → OUTLINE → DRAFT → REVISE → PUBLISH → POST-MORTEM
```

1. **Raw Idea Capture:** Record observation, contradiction, or tension
2. **Outline:** Fill pre-draft questions; pick variation dimensions
3. **Draft:** Write complete draft without editing
4. **Revise:** Run revision checklist; blind review
5. **Publish:** Add consistent tags/formatting
6. **Post-Mortem:** Record what worked, what to repeat/avoid

### Series Planning (if applicable)
- Cluster of 4-7 pieces with progression
- Plan next post fully, keep one-line placeholders for 2-3 ahead
- Theme rotation: structural, behavioral, relational, temporal, epistemic

## 6. Anti-Patterns to Avoid

| Anti-Pattern | Why It Fails | Fix |
|--------------|--------------|-----|
| Same opening every time | Reader sets their watch | Rotate opening shapes |
| Concession that agrees too much | Reversal loses force | Concede one thing, not everything |
| Multiple hidden variables | Loses focus | Name one. Cut the rest. |
| Compress that summarizes | Loses force | Replace "In summary..." with sharpened implication |
| Moralize that doesn't follow | Feels preachy | Trace moral back to reclassify in two steps |
| First person everywhere | Loses trust | Use in designated slots only |
| Hammer every paragraph | Repetition dulls force | Vary placement and density |

## 7. Quick Reference: The Pattern in 30 Seconds

```
CONCEDE (1-3 paras)
  → Acknowledge the obvious take. Earn trust.

RECLASSIFY (2-5 paras, layered)
  → Name the hidden variable.
  → Technical → Behavioral → Strategic.

COMPRESS (1-2 paras)
  → Sharpen, don't summarize.
  → Make it quotable.

MORALIZE (1-3 paras)
  → What we owe, or what to do differently.
  → Must follow from the argument.
  → Final sentence: shortest, strongest.
```
...
### `methodologies/research-core.md`
